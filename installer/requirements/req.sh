...
echo -e "\033[0;34m[INFO]\033[0m Installing Core Hyprland packages...."
sleep 2
sudo pacman -S --needed --noconfirm hyprland hyprlock hypridle hyprpicker hyprpolkitagent
echo -e "\033[0;34m[INFO]\033[0m Installing Apps...."
sleep 2
sudo pacman -S --needed --noconfirm kitty rofi-wayland waybar swaync nautilus yazi fastfetch cava
echo -e "\033[0;34m[INFO]\033[0m Installing Wayland utilities....."
sleep 2
sudo pacman -S --needed --noconfirm grim slurp swappy wl-clipboard playerctl brightnessctl pamixer pavucontrol
echo -e "\033[0;34m[INFO]\033[0m Installing System services....."
sleep 2
sudo pacman -S --needed --noconfirm network-manager-applet blueman bluez bluez-utils power-profiles-daemon
echo -e "\033[0;34m[INFO]\033[0m Installing Core utils...."
sleep 2
sudo pacman -S --needed --noconfirm linux-firmware git base-devel vim ffmpeg 7zip jq poppler fd ripgrep fzf zoxide resvg imagemagick
echo -e "\033[0;34m[INFO]\033[0m Installing Fonts....."
sudo pacman -S --needed --noconfirm noto-fonts noto-fonts-cjk noto-fonts-emoji ttf-jetbrains-mono-nerd
...
sleep 2
sudo pacman -S --needed --noconfirm cliphist util-linux xdg-utils libnotify procps-ng pacman-contrib
echo -e "\033[0;34m[INFO]\033[0m Installing extras...."
sleep 2
sudo pacman -S --needed --noconfirm unzip python-pip zip zsh hyprsunset
sleep 3
echo -e "\033[0;32m[OK]\033[0m Done!"

if command -v yay >/dev/null 2>&1; then
  echo -e "\033[0;34m[INFO]\033[0m yay already installed."
else
...
sleep 2
yay -S --needed --noconfirm awww matugen-bin rofimoji wtype ttf-font-awesome ttf-nerd-fonts-symbols-common zen-browser-bin spotify wlogout
