...
hl.on("hyprland.start", function()
	...
	hl.exec_cmd(
		"sleep 2 && awww img ~/.config/hypr/current_wallpaper --transition-type any --transition-fps 60 --transition-duration 2"
	)
	...
	hl.exec_cmd("cd ~/.config/hypr/scripts && sleep 4 && ./notify.sh")
end)
