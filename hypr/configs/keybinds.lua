...
hl.bind(mainMod .. " + Q", hl.dsp.window.close()) -- close window gracefully (same as X button)
...
hl.bind(mainMod .. " + SHIFT + C", hl.dsp.exec_cmd(scripts .. "/caffine.sh")) -- toggle idle (keep laptop awake)
...
hl.bind(
	mainMod .. " + V",
	hl.dsp.exec_cmd("cliphist list | rofi -dmenu -config " .. rofiConfig .. " | cliphist decode | wl-copy")
) -- clipboard
hl.bind(
	mainMod .. " + period",
	hl.dsp.exec_cmd('rofimoji --action type --selector-args="-config ' .. rofiConfig .. '"')
)
